...
URL = "https://af70-2a00-1858-100b-8405-1521-433f-161b-991e.ngrok.io"

# Simple Login Authentication
CLIENT_ID = "sso-app-tfgrtgaarb"
CLIENT_SECRET = "ilegcbgglthmregdryrpyxldjnuzjwvnjeskabun"
...
FB_CLIENT_ID = "348835490381722"
FB_CLIENT_SECRET = "b1157943166b265310eb6fdec354a304"
...
# Gmail authorization
GOOGLE_CLIENT_ID = '868357273033-knoa767sv0vlvccdpbpkm73usubhh97c.apps.googleusercontent.com'
GOOGLE_CLIENT_SECRET = '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'
...
def index():
    if os.path.exists('profile_data.json'):
        ...
        <a href = '/simple_login'>Login with Simple Login</a> <br>
...
def login():
	simplelogin = requests_oauthlib.OAuth2Session(
    	CLIENT_ID, redirect_uri="http://localhost:5000/simple_callback"
	)
